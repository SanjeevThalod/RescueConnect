  ...
  return (
    <div className="w-full flex flex-col items-center justify-center h-full scroll-smooth bg-gray-100">
      <div className="w-full flex flex-col items-center gap-y-10 justify-center">
        <div className="text-4xl overflow-hidden mt-2 lg:text-4xl font-bold text-black-700 text-center">
        ...
        <div className="w-11/12 lg:w-8/12 xl:w-8/12 flex flex-col md:flex-row sm:flex-col md:items-center justify-between rounded-md border border-gray-300 bg-white p-6 md:p-8 shadow-md">
          <div className="flex flex-col items-start justify-center gap-y-2">
            <div className="text-2xl font-bold text-black-500">Basic Details</div>
          ...
          {isEditable && (
            <Link to={`/update-agency/${id}`}>
              <div className="flex sm:w-full md:w-[200px] flex-row gap-x-2 items-center mt-4 md:mt-0 justify-center text-white font-bold overflow-hidden md:text-[14px] sm:text-xs sm:px-2 py-2 transition-all duration-200 border md:px-4 md:py-2 rounded-full bg-black-500 hover:bg-black-600">
          ...
          <div className="w-11/12 bg-white md:w-1/2 border md:h-72 border-gray-300 shadow-lg rounded-md p-6 md:p-10">
            ...
            {isEditable && (
              <Link to={`/update-agency-location/${id}`}>
                <div className="flex flex-row gap-x-2 items-center justify-center text-white font-bold md:text-[14px] sm:text-xs sm:px-2 py-2 transition-all duration-200 mt-4 border md:px-4 md:py-2 rounded-full bg-black-500 hover:bg-black-600">
                  <button className="text-white overflow-hidden">
                    Update Location
                  </button>
                  <FiEdit2 className="text-white" />
        ...
        <div className="w-11/12 lg:w-9/12 mt-6">
          <h2 className="text-4xl text-center font-bold overflow-hidden mb-8 text-black-600">
