  ...
  return (
    <div className="bg-gray-100 flex flex-col items-center justify-center">
      <div className="w-11/12 md:w-3/4 lg:w-2/3 flex flex-col items-center justify-center">
        <h2 className="text-3xl overflow-hidden md:h-16 sm:text-4xl md:text-5xl text-center mt-6 font-bold mb-6 text-black-600">
          Alerts Section
        </h2>
        ...
        <div className="w-6/12">
          <Link to="/createAlert">
            <button className="bg-black w-full hover:bg-gray-600 transition-all duration-200 text-white font-semibold py-2 px-4 rounded-full">
        ...
        <div className="w-full">
          <div className="overflow-hidden text-center md:h-14 text-black-600 font-sans mt-6 text-4xl font-bold">
            Received Alerts
          </div>
