  ...
  return (
    <div className="w-full bg-gray-100 flex flex-col items-center justify-center">
      <div className="w-11/12 flex flex-col items-center justify-center">
        <h2 className="md:text-5xl sm:text-3xl text-center mt-6 font-bold mb-6 overflow-hidden text-black-600">
          Disaster Events
        </h2>
        <div className="w-6/12">
          <Link to="/addDisaster">
            <button className="bg-black w-full hover:bg-black-600 transition-all duration-200 text-white font-semibold py-2 px-4 rounded-full">
              Add Disaster
            </button>
          </Link>
        </div>
        ...
        <div className="w-8/12 mt-6 mb-4">
          <label className="block text-black-600 font-bold mb-2">
            Search:
          </label>
          <input
            type="text"
