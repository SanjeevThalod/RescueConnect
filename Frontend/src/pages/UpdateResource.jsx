  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-black-600"></div>
      </div>
    );
  }
    ...
    <div className="flex flex-col items-center justify-center bg-gray-50 min-h-screen">
      <div className="w-11/12 flex flex-col items-center justify-center lg:flex-row xl:flex-row 2xl:flex-row sm:flex-col flex-wrap">
        ...
        <div className="lg:w-7/12 sm:w-full p-8">
          <h2 className="md:text-6xl sm:w-full sm:text-4xl overflow-hidden font-extrabold md:h-20 text-black-600 text-center">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="rounded-md shadow-sm">
              <div>
                ...
                <input
                  ...
                  autoComplete="name"
                  required
                  className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-black-500 focus:border-black-500 focus:z-10 sm:text-sm"
                  placeholder="Name"
                  value={formData.name}
            ...
            <div className="rounded-md flex flex-row gap-x-6 shadow-sm">
              ...
              <input
                ...
                className="h-5 w-5 text-black-600 focus:ring-black-500 border-gray-300 rounded"
              />
            </div>
            ...
            <div className="text-center w-full">
              <button
                type="submit"
                className="bg-black w-full hover:bg-black-600 transition-all duration-200 text-white font-semibold py-2 px-4 rounded-full"
              >
                Update Resource
              </button>
            </div>
