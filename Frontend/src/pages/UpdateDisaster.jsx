    ...
    <div className="flex flex-col items-center justify-center bg-gray-50 min-h-screen">
      <div className="w-11/12 flex flex-col items-center justify-center lg:flex-row xl:flex-row 2xl:flex-row sm:flex-col flex-wrap">
        ...
        <div className="lg:w-7/12  sm:w-full p-8">
          <h2 className="md:text-6xl sm:text-2xl overflow-hidden font-extrabold md:h-20 text-black-600 text-center">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center w-full">
              <button
                type="submit"
                className="bg-black-500 w-full hover:bg-black-600 transition-all duration-200 text-white font-semibold py-2 px-4 rounded-full"
              >
                Update Disaster
              </button>
            </div>
