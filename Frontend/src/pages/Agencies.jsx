...
const Agencies = () => {
  ...
  return (
    <div className="w-full bg-black-100 flex items-center gap-y-20 justify-center">
      <div className="w-full flex flex-col items-center gap-y-6 justify-center">
        <div className="overflow-hidden md:h-14 text-black-600 font-sans mt-6 text-4xl md:text-5xl font-bold">
          All Agencies List
        </div>
        {/* Filters and search */}
        <div className="w-11/12 flex flex-col items-center justify-center">
          ...
          <label className="block text-black-600 font-bold mb-2">Search:</label>
              <input
                type="text"
          ...
          <div className="flex w-8/12 md:flex-row sm:flex-col gap-x-12 mt-4 items-center justify-between">
              ...
              <div className="flex flex-col items-start">
                <div>
                  <label
                    ...
                    className="block text-black-600 font-bold mb-2"
                  >
                    Filter by Expertise:
                  </label>
                </div>
            ...
            {/* Filter by state */}
            <div className="w-full">
            <label className="block text-black-600 font-bold mb-2">State:</label>
            <select
              className="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
