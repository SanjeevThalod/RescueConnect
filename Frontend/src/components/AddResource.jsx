...
const AddResources = () => {
  ...
  return (
    <div className="mx-auto w-full sm:w-3/4 md:w-1/2 lg:w-1/3">
      <h1 className="md:text-5xl sm:text-2xl overflow-hidden md:h-16 mt-10 text-center font-bold mb-4 text-black">
        Add Resource
      </h1>
      <div className="bg-white rounded-lg shadow-lg p-6">
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="bg-black hover:bg-gray-800 transition-all duration-200 text-white font-semibold py-3 px-6 rounded-full w-full"
          >
            Create Resource
          </button>
        </form>
