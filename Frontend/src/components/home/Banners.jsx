...
import img_1 from "../../assets/banner/banner_first.jpg";
import img_2 from "../../assets/banner/banner_second.jpg";
import img_3 from "../../assets/banner/banner_third.webp";
          ...
          <div className="w-full flex flex-col justify-center md:w-1/2 mt-4 md:mt-0 md:pl-8">
            ...
            <Link to={banner.link}>
              <button
                ...
                } bg-black hover:bg-gray-800 transition-all duration-200 text-white font-bold py-2 px-4 rounded-md`}
              >
                Explore More
              </button>
            </Link>
