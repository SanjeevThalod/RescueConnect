...
const DisasterDetails = () => {
  ...
  return (
    <div className="sm:w-full md:w-11/12 mx-auto mt-4">
      <h1 className="md:text-4xl sm:text-2xl overflow-hidden font-bold text-center mb-4 text-black-600">
        Disaster Details
      </h1>
      {loadingData ? (
        ...
        <div className="bg-white shadow-2xl p-6 rounded-lg">
          <h2 className="text-xl font-bold mb-2 text-black-600">
            Disaster ID:
          </h2>
          <p className="font-bold text-gray-500 mt-2">{disasterId}</p>

          <h2 className="text-xl font-bold mb-2 mt-4 text-black-600">
            Severity:
          </h2>
          ...
          <h2 className="md:text-4xl md:h-12 sm:text-2xl overflow-hidden font-bold mt-4 text-black-600">
              ...
              {agencies.map((agency) => (
                <li key={agency._id} className="font-bold text-gray-500 mt-2">
                  <div className="w-full">
                    Name of Agency :
                    <span className="text-lg font-Roborto text-black-500">
                      {agency.name}
                    </span>
                    <br></br>
                    Email:
