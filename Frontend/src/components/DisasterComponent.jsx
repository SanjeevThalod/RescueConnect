...
const DisasterComponent = ({ disaster }) => {
  ...
  return (
    <div className="bg-white border-2 shadow-md p-4 rounded-lg max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-lg">
      <h3 className="text-2xl font-bold text-black-800">{disaster.typeOfDisaster}</h3>
      ...
      <button
        className="mt-4 bg-black hover:bg-black-600 w-full text-white font-semibold py-2 px-4 rounded-full transition-all duration-200"
